...
public class NotificationServicePropertyTests
{
    ...
    public async Task Property_63_AssignmentCreatesNotificationWithCardTitleAndAssignerInfo()
    {
        ...
        Assert.Equal(NotificationType.Assigned, persisted.Type);
        Assert.Equal(assigneeId, persisted.UserId);
        Assert.Equal(assignerId, persisted.CreatedBy);
        Assert.Equal(EntityType.Card, persisted.EntityType);
    ...
    public async Task Property_65_UnreadCountMatchesActualUnreadNotifications()
    {
        ...
        var readOne = await fixture.NotificationService.CreateAsync(userId, NotificationType.Created, "Created A", "A");
        var unreadOne = await fixture.NotificationService.CreateAsync(userId, NotificationType.Updated, "Updated B", "B");
        var unreadTwo = await fixture.NotificationService.CreateAsync(userId, NotificationType.Moved, "Moved C", "C");
        _ = await fixture.NotificationService.CreateAsync(otherUserId, NotificationType.Deleted, "Other", "Other");
    ...
    public async Task Property_71_ListAsyncReturnsAllUserNotificationsForPage()
    {
        ...
        _ = await fixture.NotificationService.CreateAsync(otherUserId, NotificationType.Updated, "Other", "Other");
    ...
    public async Task Property_73_ReadUnreadStatusIsMaintainedAcrossOperations()
    {
        ...
        var firstUnread = await fixture.NotificationService.CreateAsync(userId, NotificationType.Created, "A", "A");
        var secondUnread = await fixture.NotificationService.CreateAsync(userId, NotificationType.Updated, "B", "B");
        var alreadyRead = await fixture.NotificationService.CreateAsync(userId, NotificationType.Moved, "C", "C");
    ...
    public async Task Property_74_MarkAllAsReadUpdatesAllUnreadNotifications()
    {
        ...
        var userUnreadOne = await fixture.NotificationService.CreateAsync(userId, NotificationType.Created, "A", "A");
        _ = await fixture.NotificationService.CreateAsync(userId, NotificationType.Updated, "B", "B");
        var userReadOne = await fixture.NotificationService.CreateAsync(userId, NotificationType.Moved, "C", "C");
        var otherUnread = await fixture.NotificationService.CreateAsync(otherUserId, NotificationType.Deleted, "D", "D");
    ...
    public async Task Property_75_DeleteRemovesNotificationFromList()
    {
        ...
        var keepOne = await fixture.NotificationService.CreateAsync(userId, NotificationType.Created, "Keep one", "Keep one");
        var toDelete = await fixture.NotificationService.CreateAsync(userId, NotificationType.Updated, "Delete me", "Delete me");
        var keepTwo = await fixture.NotificationService.CreateAsync(userId, NotificationType.Moved, "Keep two", "Keep two");
