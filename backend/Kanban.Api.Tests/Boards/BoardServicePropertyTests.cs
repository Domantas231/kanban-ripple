...
public class BoardServicePropertyTests
{
    ...
    public async Task Property_26_CreateWithoutNameReturnsError()
    {
        ...
        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board name validation project");
    ...
    public async Task Property_27_UpdateNamePersistsAndSubsequentQueryReturnsNewName()
    {
        var fixture = CreateFixture();
        var ownerId = Guid.NewGuid();
        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board update persistence project");
    ...
    public async Task Property_28_ArchiveSoftDeletesBoardColumnsAndCardsAndExcludesThemFromNormalQueries()
    {
        var fixture = CreateFixture();
        var ownerId = Guid.NewGuid();
        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board archive property project");
    ...
    public async Task CreateAsync_AssociatesBoardWithProject_AndRequiresMemberPlus()
    {
        ...
        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board create project");
    ...
    public async Task GetByIdAsync_AllowsViewerPlus_AndDeniesOutsider()
    {
        ...
        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board read project");
    ...
    [Fact]
    public async Task ListAsync_ReturnsProjectBoardsOrderedByLatestActivityDescending()
    {
        var fixture = CreateFixture();
        var ownerId = Guid.NewGuid();

        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board list project");
        var now = DateTime.UtcNow;
        ...
        Assert.Collection(
            boards,
            board => Assert.Equal("Newest", board.Name),
            board => Assert.Equal("Middle", board.Name),
            board => Assert.Equal("Oldest", board.Name));
    }
    ...
    public async Task UpdateAsync_UpdatesNameAndPosition_AndRequiresMemberPlus()
    {
        ...
        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board update project");
        fixture.DbContext.ProjectMembers.Add(new ProjectMember
        {
            Id = Guid.NewGuid(),
            ProjectId = project.Id,
    ...
    public async Task ArchiveAsync_SoftDeletesBoardColumnsAndCards()
    {
        var fixture = CreateFixture();
        var ownerId = Guid.NewGuid();
        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board archive project");
        var now = DateTime.UtcNow;
    ...
    public async Task RestoreAsync_ClearsDeletedAtForBoardColumnsAndCards()
    {
        var fixture = CreateFixture();
        var ownerId = Guid.NewGuid();
        var project = await fixture.ProjectService.CreateAsync(ownerId, "Board restore project");
        var now = DateTime.UtcNow;
