...
interface OverviewUpcomingDeadlinesProps {
  cards: FlatCard[]
...
export function OverviewUpcomingDeadlines({ cards, onCardClick }: OverviewUpcomingDeadlinesProps) {
  ...
  return (
    <Box>
      ...
      >
        <CalendarTodayOutlinedIcon sx={{ fontSize: 20, color: 'primary.main' }} />
